    ...
    if let Some(nb32) = NostrBech32::try_from_string(&bech32) {
        match nb32 {
            NostrBech32::EventAddr(ea) => {
                ...
                println!("  d={}", ea.d);
                println!("  relays={}", ea.relays.iter().map(|r| r.as_str().to_owned())
            ...
            NostrBech32::EventPointer(ep) => {
                ...
                println!("  relays={}", ep.relays.iter().map(|r| r.as_str().to_owned())
                         .collect::<Vec<String>>().join(", "));
            ...
            NostrBech32::Profile(profile) => {
                ...
                println!("  relays={}", profile.relays.iter().map(|r| r.as_str().to_owned())
                         .collect::<Vec<String>>().join(", "));
